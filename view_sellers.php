...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-dashboard"></i> Dashboard / Approved Sellers
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-check-circle fa-fw"></i> Approved Sellers
                </h3>
            </div>
            <div class="panel-body">
                <div class="table-responsive">
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        echo "<div class='alert alert-warning text-center'>No approved sellers found.</div>";
                    }
                    ?>
                </div>
            </div>
