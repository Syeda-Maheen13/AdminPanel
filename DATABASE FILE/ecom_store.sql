...
INSERT INTO sellers (name, email, phone, status) VALUES
('Ali Khan', 'ali@example.com', '03001234567', 'pending'),
('Sara Ahmed', 'sara@example.com', '03123456789', 'pending'),
('Zain Raza', 'zain@example.com', '03214567890', 'approved'),
('Hina Sheikh', 'hina@example.com', '03325678901', 'rejected'),
('Kamran Haider', 'kamran@example.com', '03436789012', 'pending'),
('Ayesha Noor', 'ayesha@example.com', '03547890123', 'approved'),
('Umar Farooq', 'umar@example.com', '03658901234', 'pending'),
('Farah Javed', 'farah@example.com', '03769012345', 'rejected'),
('Danish Ali', 'danish@example.com', '03870123456', 'approved'),
('Nadia Malik', 'nadia@example.com', '03981234567', 'pending');

-- Insert sample seller details
INSERT INTO seller_details (seller_id, business_name, address, document) VALUES
(1, 'Ali Electronics', 'Lahore, Pakistan', 'ali_docs.pdf'),
(2, 'Sara Fashion', 'Karachi, Pakistan', 'sara_docs.pdf'),
(3, 'Zain Tech', 'Islamabad, Pakistan', 'zain_docs.pdf'),
(4, 'Hina Beauty', 'Rawalpindi, Pakistan', 'hina_docs.pdf'),
(5, 'Kamran Hardware', 'Faisalabad, Pakistan', 'kamran_docs.pdf'),
(6, 'Ayesha Clothing', 'Sialkot, Pakistan', 'ayesha_docs.pdf'),
(7, 'Umar Bakery', 'Multan, Pakistan', 'umar_docs.pdf'),
(8, 'Farah Interiors', 'Quetta, Pakistan', 'farah_docs.pdf'),
(9, 'Danish Motors', 'Peshawar, Pakistan', 'danish_docs.pdf'),
(10, 'Nadia Foods', 'Hyderabad, Pakistan', 'nadia_docs.pdf');

-- Insert sample admin actions
INSERT INTO admin_actions (seller_id, admin_id, action) VALUES
(1, 1, 'approved'),
(2, 1, 'rejected'),
(3, 2, 'approved'),
(4, 2, 'rejected'),
...
('Ali Khan', 'ali@example.com', '03001234567', 'hashed_password1'),
('Arhab Khan', 'arhab@example.com', '03003234567', 'hashed_password2'),
('zaroon Khan', 'zaroon@example.com', '0300123567', 'hashed_password3'),
('Sara Ahmed', 'sara@example.com', '03123456789', 'hashed_password4');
